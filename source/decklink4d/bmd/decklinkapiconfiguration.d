...
module decklink4d.bmd.decklinkapiconfiguration;
...
enum 
		/+[v1_enum]+/ /+	_BMDDeckLinkConfigurationID+/
{
...
alias int	_BMDDeckLinkConfigurationID;
alias int BMDDeckLinkConfigurationID;
...
const GUID IID_IDeckLinkConfiguration = IDeckLinkConfiguration.iid;

interface IDeckLinkConfiguration : IUnknown
{
extern(System):
    static const GUID iid = { 0xC679A35B,0x610C,0x4D09,[ 0xB7,0x48,0x1D,0x04,0x78,0x10,0x0F,0xC0 ] };
    HRESULT SetFlag(in BMDDeckLinkConfigurationID cfgID, in BOOL value);
    HRESULT GetFlag(in BMDDeckLinkConfigurationID cfgID, 
		/+[out]+/ BOOL *value);
    HRESULT SetInt(in BMDDeckLinkConfigurationID cfgID, in LONGLONG value);
    HRESULT GetInt(in BMDDeckLinkConfigurationID cfgID, 
		/+[out]+/ LONGLONG *value);
